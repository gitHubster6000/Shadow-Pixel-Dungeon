...
import com.rexbattler41.shadowpixeldungeon.windows.WndDailies;
import com.rexbattler41.shadowpixeldungeon.windows.WndError;
import com.rexbattler41.shadowpixeldungeon.windows.WndRanking;
		...
		if (Rankings.INSTANCE.latestDaily != null) {
			IconButton btnDailies = new IconButton(Icons.CALENDAR.get()) {
				...
				protected void onClick() {
					shadowpixeldungeon.scene().addToFront(new WndDailies());
				}
