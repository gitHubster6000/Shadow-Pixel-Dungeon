...
import com.rexbattler41.shadowpixeldungeon.windows.IconTitle;
import com.rexbattler41.shadowpixeldungeon.windows.WndTitledMessage;
...
public class NewsScene extends PixelScene {
	...
	private static class ArticleButton extends StyledButton {
		...
		protected void onClick() {
			...
			shadowpixeldungeon.scene().addToFront(new WndArticle(article));
		}
	}
