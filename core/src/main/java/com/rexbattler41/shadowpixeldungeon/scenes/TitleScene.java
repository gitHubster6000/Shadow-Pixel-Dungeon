...
import com.rexbattler41.shadowpixeldungeon.effects.BannerSprites;
import com.rexbattler41.shadowpixeldungeon.effects.Fireball;
...
import com.rexbattler41.shadowpixeldungeon.services.updates.AvailableUpdateData;
...
import com.rexbattler41.shadowpixeldungeon.windows.WndSettings;
...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		StyledButton btnPlay = new StyledButton(GREY_TR, Messages.get(this, "enter")){
			...
			protected void onClick() {
				if (GamesInProgress.checkAll().size() == 0){
					...
					shadowpixeldungeon.switchNoFade( StartScene.class );
				}
			}
		...
		StyledButton btnRankings = new StyledButton(GREY_TR,Messages.get(this, "rankings")){
			@Override
			protected void onClick() {
				shadowpixeldungeon.switchNoFade( RankingsScene.class );
			}
		};
...
Dungeon.daily = Dungeon.dailyReplay = false;
		...
		StyledButton btnBadges = new StyledButton(GREY_TR, Messages.get(this, "badges")){
			@Override
			protected void onClick() {
				shadowpixeldungeon.switchNoFade( BadgesScene.class );
			}
		};
		...
		StyledButton btnAbout = new StyledButton(GREY_TR, Messages.get(this, "about")){
			@Override
			protected void onClick() {
				shadowpixeldungeon.switchScene( AboutScene.class );
			}
		};
	...
	private static class NewsButton extends StyledButton {
		...
		protected void onClick() {
			super.onClick();
			shadowpixeldungeon.switchNoFade( NewsScene.class );
		}
	}
				...
				shadowpixeldungeon.scene().addToFront(new WndOptions(
					...
					protected void onSelect(int index) {
						if (index == 0) {
							...
							shadowpixeldungeon.switchNoFade( ChangesScene.class );
						}
					}
				});
	...
	private static class SettingsButton extends StyledButton {
		...
		protected void onClick() {
			...
			shadowpixeldungeon.scene().add(new WndSettings());
		}
	}
	...
	private static class SupportButton extends StyledButton{
		...
		@Override
		protected void onClick() {
			shadowpixeldungeon.switchNoFade(SupporterScene.class);
		}
	}
}
