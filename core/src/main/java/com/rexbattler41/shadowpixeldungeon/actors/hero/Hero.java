...
import com.rexbattler41.shadowpixeldungeon.actors.mobs.Snake;
import com.rexbattler41.shadowpixeldungeon.actors.mobs.npcs.Bbat;
import com.rexbattler41.shadowpixeldungeon.actors.mobs.npcs.Hook;
import com.rexbattler41.shadowpixeldungeon.effects.*;
import com.rexbattler41.shadowpixeldungeon.items.*;
import com.rexbattler41.shadowpixeldungeon.items.Heap.Type;
...
import com.rexbattler41.shadowpixeldungeon.items.armor.glyphs.AntiMagic;
import com.rexbattler41.shadowpixeldungeon.items.armor.glyphs.Brimstone;
import com.rexbattler41.shadowpixeldungeon.items.armor.glyphs.Viscosity;
import com.rexbattler41.shadowpixeldungeon.items.artifacts.*;
import com.rexbattler41.shadowpixeldungeon.items.bags.MagicalHolster;
import com.rexbattler41.shadowpixeldungeon.items.fishingrods.FishingRod;
import com.rexbattler41.shadowpixeldungeon.items.journal.Guidebook;
import com.rexbattler41.shadowpixeldungeon.items.keys.*;
import com.rexbattler41.shadowpixeldungeon.items.potions.Potion;
import com.rexbattler41.shadowpixeldungeon.items.potions.PotionOfExperience;
import com.rexbattler41.shadowpixeldungeon.items.potions.PotionOfHealing;
import com.rexbattler41.shadowpixeldungeon.items.potions.elixirs.ElixirOfMight;
import com.rexbattler41.shadowpixeldungeon.items.rings.*;
...
import com.rexbattler41.shadowpixeldungeon.items.scrolls.ScrollOfUpgrade;
import com.rexbattler41.shadowpixeldungeon.items.scrolls.exotic.ScrollOfChallenge;
...
import com.rexbattler41.shadowpixeldungeon.items.weapon.melee.*;
...
import com.rexbattler41.shadowpixeldungeon.levels.features.Chasm;
...
import com.rexbattler41.shadowpixeldungeon.scenes.AlchemyScene;
...
import com.rexbattler41.shadowpixeldungeon.scenes.SurfaceScene;
...
import com.rexbattler41.shadowpixeldungeon.ui.QuickSlotButton;
import com.rexbattler41.shadowpixeldungeon.utils.BArray;
import com.rexbattler41.shadowpixeldungeon.utils.GLog;
import com.rexbattler41.shadowpixeldungeon.windows.WndMessage;
import com.rexbattler41.shadowpixeldungeon.windows.WndOptions;
import com.rexbattler41.shadowpixeldungeon.windows.WndResurrect;
import com.rexbattler41.shadowpixeldungeon.windows.WndTradeItem;
	...
	public void checkVisibleMobs() {
		...
		for (Mob m : Dungeon.level.mobs.toArray(new Mob[0])) {
		    if (m instanceof Hook && !fieldOfView[m.pos]){
		        m.die(new com.rexbattler41.shadowpixeldungeon.actors.buffs.Doom());
