...
import com.rexbattler41.shadowpixeldungeon.actors.hero.*;
import com.rexbattler41.shadowpixeldungeon.actors.mobs.npcs.DirectableAlly;
...
import com.rexbattler41.shadowpixeldungeon.effects.Surprise;
import com.rexbattler41.shadowpixeldungeon.effects.Wound;
...
import com.rexbattler41.shadowpixeldungeon.items.artifacts.MasterThievesArmband;
...
import com.rexbattler41.shadowpixeldungeon.items.stones.StoneOfAggression;
import com.rexbattler41.shadowpixeldungeon.items.weapon.SpiritBow;
import com.rexbattler41.shadowpixeldungeon.items.weapon.enchantments.Lucky;
...
import com.rexbattler41.shadowpixeldungeon.levels.OldCavesBossLevel;
...
import static com.rexbattler41.shadowpixeldungeon.items.fishingrods.FishingRod.AC_UNCAST;
	...
	public static void holdAllies( Level level, int holdFromPos ){
		...
		for (Mob mob : level.mobs.toArray( new Mob[0] )) {
			...
			if (mob instanceof Hook){
                mob.die(new com.rexbattler41.shadowpixeldungeon.actors.buffs.Doom());
