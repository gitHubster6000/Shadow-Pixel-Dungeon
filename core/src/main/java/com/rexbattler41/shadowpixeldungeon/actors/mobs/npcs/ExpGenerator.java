...
import com.rexbattler41.shadowpixeldungeon.sprites.ExpGenSprite;
...
public class ExpGenerator extends Mob {
    ...
    public void die(Object cause) {
        ...
        Dungeon.level.drop(new com.rexbattler41.shadowpixeldungeon.items.ExpGenerator().upgrade(level - 1), pos).sprite.drop();
    }
