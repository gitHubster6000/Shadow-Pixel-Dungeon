		...
		public StatsTab() {
			...
			IconButton scoreInfo = new IconButton(Icons.get(Icons.INFO)){
				...
				protected void onClick() {
					super.onClick();
					shadowpixeldungeon.scene().addToFront(new WndScoreBreakdown());
				}
			};
			...
			if (Dungeon.seed != -1 && !Dungeon.daily &&
				...
				RedButton btnSeed = new RedButton(Messages.get(this, "copy_seed")){
					...
					protected void onClick() {
						super.onClick();
						shadowpixeldungeon.scene().addToFront(new WndOptions(new Image(icon),
