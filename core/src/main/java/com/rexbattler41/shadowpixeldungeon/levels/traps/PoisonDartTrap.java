...
import com.rexbattler41.shadowpixeldungeon.actors.buffs.Poison;
import com.rexbattler41.shadowpixeldungeon.items.weapon.missiles.darts.PoisonDart;
			...
			if (Dungeon.level.heroFOV[pos] || Dungeon.level.heroFOV[target.pos]) {
				Actor.add(new Actor() {
					...
					protected boolean act() {
						...
						((MissileSprite) shadowpixeldungeon.scene().recycle(MissileSprite.class)).
