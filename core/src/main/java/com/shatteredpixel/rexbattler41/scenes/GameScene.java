...
package com.shatteredpixel.rexbattler41.scenes;
...
import com.shatteredpixel.rexbattler41.actors.buffs.ChampionEnemy;
...
import com.shatteredpixel.rexbattler41.actors.mobs.DemonSpawner;
...
import com.shatteredpixel.rexbattler41.items.Ankh;
import com.shatteredpixel.rexbattler41.items.Heap;
import com.shatteredpixel.rexbattler41.items.Honeypot;
...
import com.shatteredpixel.rexbattler41.levels.RegularLevel;
...
import com.shatteredpixel.rexbattler41.sprites.*;
import com.shatteredpixel.rexbattler41.tiles.*;
import com.shatteredpixel.rexbattler41.ui.*;
import com.shatteredpixel.rexbattler41.utils.GLog;
import com.shatteredpixel.rexbattler41.windows.*;
...
public class GameScene extends PixelScene {
	...
	public void create() {
		...
		if (Dungeon.hero == null || Dungeon.level == null){
			shadowpixeldungeon.switchNoFade(TitleScene.class);
			return;
		}
	...
	public static void gameOver() {
		...
		StyledButton restart = new StyledButton(Chrome.Type.GREY_BUTTON_TR, Messages.get(StartScene.class, "new"), 9){
			...
			protected void onClick() {
				...
				shadowpixeldungeon.switchScene(HeroSelectScene.class);
			}
