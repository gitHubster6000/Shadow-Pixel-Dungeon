...
import com.shatteredpixel.rexbattler41.items.potions.exotic.PotionOfHolyFuror;
import com.shatteredpixel.rexbattler41.scenes.GameScene;
import com.shatteredpixel.rexbattler41.scenes.PixelScene;
import com.shatteredpixel.rexbattler41.scenes.TitleScene;
...
public class shadowpixeldungeon extends Game {
	...
	public shadowpixeldungeon(PlatformSupport platform ) {
		...
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.rexbattler41.actors.buffs.Bleeding.class,
				"com.shatteredpixel.shadowpixeldungeon.levels.features.Chasm$FallBleed" );
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.rexbattler41.plants.Mageroyal.class,
				"com.shatteredpixel.shadowpixeldungeon.plants.Dreamfoil" );
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.rexbattler41.plants.Mageroyal.Seed.class,
				"com.shatteredpixel.shadowpixeldungeon.plants.Dreamfoil$Seed" );

		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.rexbattler41.items.weapon.curses.Dazzling.class,
				"com.shatteredpixel.shadowpixeldungeon.items.weapon.curses.Exhausting" );
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.rexbattler41.items.weapon.curses.Explosive.class,
				"com.shatteredpixel.shadowpixeldungeon.items.weapon.curses.Fragile" );

		//pre-v1.2.0
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.rexbattler41.items.weapon.missiles.darts.CleansingDart.class,
				"com.shatteredpixel.shadowpixeldungeon.items.weapon.missiles.darts.SleepDart" );

		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.rexbattler41.levels.rooms.special.CrystalVaultRoom.class,
				"com.shatteredpixel.shadowpixeldungeon.levels.rooms.special.VaultRoom" );

		//pre-v1.1.0
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.rexbattler41.items.scrolls.exotic.ScrollOfDread.class,
				"com.shatteredpixel.shadowpixeldungeon.items.scrolls.exotic.ScrollOfPetrification" );
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.rexbattler41.items.scrolls.exotic.ScrollOfSirensSong.class,
		...
		com.watabou.utils.Bundle.addAlias(
				com.shatteredpixel.rexbattler41.items.potions.exotic.PotionOfMastery.class,
