...
import com.shatteredpixel.rexbattler41.actors.blobs.SacrificialFire;
...
import com.shatteredpixel.rexbattler41.actors.mobs.Monk;
import com.shatteredpixel.rexbattler41.actors.mobs.Snake;
import com.shatteredpixel.rexbattler41.actors.mobs.npcs.Bbat;
import com.shatteredpixel.rexbattler41.actors.mobs.npcs.Hook;
import com.shatteredpixel.rexbattler41.effects.*;
import com.shatteredpixel.rexbattler41.items.*;
import com.shatteredpixel.rexbattler41.items.Heap.Type;
import com.shatteredpixel.rexbattler41.items.armor.Armor;
import com.shatteredpixel.rexbattler41.items.armor.ClassArmor;
import com.shatteredpixel.rexbattler41.items.armor.glyphs.AntiMagic;
import com.shatteredpixel.rexbattler41.items.armor.glyphs.Brimstone;
import com.shatteredpixel.rexbattler41.items.armor.glyphs.Viscosity;
import com.shatteredpixel.rexbattler41.items.artifacts.*;
...
import com.shatteredpixel.rexbattler41.items.journal.Guidebook;
import com.shatteredpixel.rexbattler41.items.keys.*;
...
import com.shatteredpixel.rexbattler41.items.rings.*;
import com.shatteredpixel.rexbattler41.items.scrolls.Scroll;
import com.shatteredpixel.rexbattler41.items.scrolls.ScrollOfMagicMapping;
import com.shatteredpixel.rexbattler41.items.scrolls.ScrollOfUpgrade;
import com.shatteredpixel.rexbattler41.items.scrolls.exotic.ScrollOfChallenge;
import com.shatteredpixel.rexbattler41.items.wands.Wand;
import com.shatteredpixel.rexbattler41.items.wands.WandOfBlastWave;
import com.shatteredpixel.rexbattler41.items.wands.WandOfLivingEarth;
import com.shatteredpixel.rexbattler41.items.weapon.SpiritBow;
import com.shatteredpixel.rexbattler41.items.weapon.Weapon;
import com.shatteredpixel.rexbattler41.items.weapon.melee.*;
import com.shatteredpixel.rexbattler41.items.weapon.missiles.MissileWeapon;
import com.shatteredpixel.rexbattler41.journal.Document;
...
import com.shatteredpixel.rexbattler41.levels.features.LevelTransition;
...
import com.shatteredpixel.rexbattler41.mechanics.ShadowCaster;
import com.shatteredpixel.rexbattler41.messages.Messages;
import com.shatteredpixel.rexbattler41.plants.Swiftthistle;
import com.shatteredpixel.rexbattler41.scenes.AlchemyScene;
import com.shatteredpixel.rexbattler41.scenes.GameScene;
import com.shatteredpixel.rexbattler41.scenes.InterlevelScene;
import com.shatteredpixel.rexbattler41.scenes.SurfaceScene;
...
import com.shatteredpixel.rexbattler41.ui.AttackIndicator;
import com.shatteredpixel.rexbattler41.ui.BuffIndicator;
import com.shatteredpixel.rexbattler41.ui.QuickSlotButton;
import com.shatteredpixel.rexbattler41.utils.BArray;
import com.shatteredpixel.rexbattler41.utils.GLog;
import com.shatteredpixel.rexbattler41.windows.WndMessage;
import com.shatteredpixel.rexbattler41.windows.WndOptions;
import com.shatteredpixel.rexbattler41.windows.WndResurrect;
import com.shatteredpixel.rexbattler41.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	private boolean actAlchemy( HeroAction.Alchemy action ) {
		...
		if (Dungeon.level.distance(dst, pos) <= 1) {
			...
			shadowpixeldungeon.switchScene(AlchemyScene.class);
			return false;
	...
	public void checkVisibleMobs() {
		...
		for (Mob m : Dungeon.level.mobs.toArray(new Mob[0])) {
		    if (m instanceof Hook && !fieldOfView[m.pos]){
		        m.die(new com.shatteredpixel.rexbattler41.actors.buffs.Doom());
