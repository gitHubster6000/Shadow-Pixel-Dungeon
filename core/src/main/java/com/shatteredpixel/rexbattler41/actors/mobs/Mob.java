...
import com.shatteredpixel.rexbattler41.actors.hero.*;
import com.shatteredpixel.rexbattler41.actors.mobs.npcs.DirectableAlly;
...
import com.shatteredpixel.rexbattler41.effects.Surprise;
import com.shatteredpixel.rexbattler41.effects.Wound;
...
import com.shatteredpixel.rexbattler41.items.artifacts.MasterThievesArmband;
...
import com.shatteredpixel.rexbattler41.items.stones.StoneOfAggression;
import com.shatteredpixel.rexbattler41.items.weapon.SpiritBow;
import com.shatteredpixel.rexbattler41.items.weapon.enchantments.Lucky;
import com.shatteredpixel.rexbattler41.items.weapon.missiles.MissileWeapon;
import com.shatteredpixel.rexbattler41.items.weapon.missiles.darts.Dart;
import com.shatteredpixel.rexbattler41.levels.Level;
import com.shatteredpixel.rexbattler41.levels.OldCavesBossLevel;
...
import static com.shatteredpixel.rexbattler41.items.fishingrods.FishingRod.AC_UNCAST;
	...
	public static void holdAllies( Level level, int holdFromPos ){
		...
		for (Mob mob : level.mobs.toArray( new Mob[0] )) {
			...
			if (mob instanceof Hook){
                mob.die(new com.shatteredpixel.rexbattler41.actors.buffs.Doom());
