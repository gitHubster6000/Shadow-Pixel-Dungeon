...
import com.shatteredpixel.rexbattler41.sprites.ExpGenSprite;
...
public class ExpGenerator extends Mob {
    ...
    public void die(Object cause) {
        ...
        Dungeon.level.drop(new com.shatteredpixel.rexbattler41.items.ExpGenerator().upgrade(level - 1), pos).sprite.drop();
    }
