...
import com.shatteredpixel.rexbattler41.items.wands.CursedWand;
...
public abstract class Elemental extends Mob {
	...
	public static class FireElemental extends Elemental {
		
		{
			...
			harmfulBuffs.add( com.shatteredpixel.rexbattler41.actors.buffs.Frost.class );
